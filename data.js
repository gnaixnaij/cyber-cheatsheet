const SECTIONS = [
  {
    ...
    commands: [
      { title: 'nmap — Basic scan', desc: 'Fast port scan on target', diff: null, code: 'nmap -sS -sV -O <target>' },
      { title: 'nmap — All ports + scripts', desc: 'Full TCP scan with default scripts', diff: null, code: 'nmap -p- -sC -sV -T4 <target>' },
      { title: 'nmap — UDP scan', desc: 'Common UDP ports', diff: null, code: 'nmap -sU --top-ports 100 <target>' },
      { title: 'nmap — Output to all formats', desc: 'Normal, XML, grepable', diff: null, code: 'nmap -oA scan_output <target>' },
