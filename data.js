const SECTIONS = [
  {
    ...
    commands: [
      { title: 'nmap — Basic scan', desc: 'Default scan on target IP', diff: 'easy', code: 'nmap 192.168.1.1' },
      { title: 'nmap — TCP SYN scan', desc: 'Stealth scan without completing TCP handshake', diff: 'easy', code: 'nmap -sS 192.168.1.1' },
      { title: 'nmap — Specific port', desc: 'Scan a single port', diff: 'easy', code: 'nmap -p 22 192.168.1.1' },
      { title: 'nmap — Port range', desc: 'Scan a range of ports', diff: 'easy', code: 'nmap -p 20-23 192.168.1.1' },
      { title: 'nmap — All ports', desc: 'Full 65535 port TCP scan', diff: 'medium', code: 'nmap -p- -sC -sV -T4 <target>' },
      { title: 'nmap — UDP scan', desc: 'Scan common UDP ports', diff: 'medium', code: 'nmap -sU --top-ports 100 192.168.1.1' },
      { title: 'nmap — Service detection', desc: 'Identify service versions on open ports', diff: 'easy', code: 'nmap -sV 192.168.1.1' },
      { title: 'nmap — OS detection', desc: 'Determine target operating system', diff: 'medium', code: 'nmap -O 192.168.1.1' },
      { title: 'nmap — Aggressive scan', desc: 'OS + version + scripts + traceroute', diff: 'medium', code: 'nmap -A 192.168.1.1' },
      { title: 'nmap — Ping sweep', desc: 'Discover live hosts on subnet', diff: 'easy', code: 'nmap -sn 192.168.1.0/24' },
      { title: 'nmap — Scan subnet', desc: 'Scan all devices in CIDR range', diff: 'easy', code: 'nmap 192.168.1.0/24' },
      { title: 'nmap — Multiple hosts', desc: 'Scan several targets at once', diff: 'easy', code: 'nmap 192.168.1.1 192.168.1.2' },
      { title: 'nmap — Verbose output', desc: 'Detailed scan progress', diff: 'easy', code: 'nmap -v 192.168.1.1' },
      { title: 'nmap — NSE script', desc: 'Run a specific NSE script (http-enum)', diff: 'medium', code: 'nmap --script http-enum 192.168.1.1' },
      { title: 'nmap — Save TXT', desc: 'Save output to text file', diff: 'easy', code: 'nmap -oN output.txt 192.168.1.1' },
      { title: 'nmap — Save XML', desc: 'Save output to XML file', diff: 'easy', code: 'nmap -oX output.xml 192.168.1.1' },
      { title: 'nmap — All formats', desc: 'Normal, XML, grepable at once', diff: 'easy', code: 'nmap -oA scan_output <target>' },
      { title: 'nmap — Timing template', desc: 'Aggressive timing (fast scan)', diff: 'easy', code: 'nmap -T4 192.168.1.1' },
      { title: 'nmap — Firewall bypass', desc: 'Skip host discovery (assume host is up)', diff: 'medium', code: 'nmap -Pn 192.168.1.1' },
      { title: 'nmap — Randomize hosts', desc: 'Scan hosts in random order to evade detection', diff: 'hard', code: 'nmap --randomize-hosts 192.168.1.0/24' },
      { title: 'nmap — Exclude hosts', desc: 'Exclude specific IPs from scan', diff: 'easy', code: 'nmap --exclude 192.168.1.1 192.168.1.0/24' },
      { title: 'nmap — Traceroute', desc: 'Show packet route to target', diff: 'medium', code: 'nmap --traceroute 192.168.1.1' },
      { title: 'nmap — OS fingerprint', desc: 'Combine OS + service version detection', diff: 'medium', code: 'nmap -O -sV 192.168.1.1' },
      { title: 'nmap — DNS enumeration', desc: 'List hosts without scanning them', diff: 'medium', code: 'nmap -sL 192.168.1.0/24' },
      { title: 'nmap — Version all', desc: 'Detect all possible services aggressively', diff: 'hard', code: 'nmap -sV --version-all 192.168.1.1' },
