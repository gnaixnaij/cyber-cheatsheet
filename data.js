const SECTIONS = [
  {
    ...
    commands: [
      { title: 'nmap — Basic scan', desc: 'Default scan on target IP', diff: 'easy', code: 'nmap <target>' , output: 'PORT   STATE SERVICE | 22/tcp open  ssh | 80/tcp open  http | Nmap done in 3.42s'},
      { title: 'nmap — TCP SYN scan', desc: 'Stealth scan without completing TCP handshake', diff: 'easy', code: 'nmap -sS <target>' , output: 'PORT     STATE  SERVICE | 22/tcp   open   ssh | 80/tcp   open   http | 443/tcp  closed https'},
      { title: 'nmap — Specific port', desc: 'Scan a single port', diff: 'easy', code: 'nmap -p <port> <target>' , output: 'PORT   STATE SERVICE | 80/tcp open  http | Nmap done in 0.87s'},
      { title: 'nmap — Port range', desc: 'Scan a range of ports', diff: 'easy', code: 'nmap -p <start>-<end> <target>' },
      { title: 'nmap — All ports', desc: 'Full 65535 port TCP scan', diff: 'medium', code: 'nmap -p- -sC -sV -T4 <target>' , output: '22/tcp open ssh OpenSSH 8.9p1 | 80/tcp open http Apache 2.4.57 | Nmap done in 265s'},
      { title: 'nmap — UDP scan', desc: 'Scan common UDP ports', diff: 'medium', code: 'nmap -sU --top-ports 100 <target>' },
      { title: 'nmap — Service detection', desc: 'Identify service versions on open ports', diff: 'easy', code: 'nmap -sV <target>' , output: '22/tcp open ssh OpenSSH 8.9p1 | 80/tcp open http Apache 2.4.57 | Nmap done in 6.85s'},
      { title: 'nmap — OS detection', desc: 'Determine target operating system', diff: 'medium', code: 'nmap -O <target>' , output: 'Aggressive OS guesses: Linux 5.x (95%) | No exact OS matches'},
      { title: 'nmap — Aggressive scan', desc: 'OS + version + scripts + traceroute', diff: 'medium', code: 'nmap -A <target>' , output: '22/tcp open ssh OpenSSH 8.9p1 | 80/tcp open http Apache 2.4.57 | TRACEROUTE 2  10.10.10.1  0.85ms'},
      { title: 'nmap — Ping sweep', desc: 'Discover live hosts on subnet', diff: 'easy', code: 'nmap -sn <subnet>' , output: 'Nmap done: 256 IPs (5 hosts up) in 3.21s'},
